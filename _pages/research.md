...
**Australia.** 
![]({{ site.url }}{{ site.baseurl }}/images/respic/aus.jpg){: style="width: 250px; float: right; margin: 0px  10px"}
...
<figure>
<img src="{{ site.url }}{{ site.baseurl }}/images/picpic/Gallery/chile.jpg" width="95%">
</figure>
